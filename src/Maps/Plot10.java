...
public class Plot10 extends Map {

	public Plot10(GameContainer gc) throws SlickException {
		super(gc);
		...
		speciesList.add(3, new Panicum(2));
		...
		for(int i = 0; i < (tileTotal); i++){
			...
			if(plantArray[temp] == null && roll1 == 2){
				...
				if(roll2 == 3) plantArray[temp] = new Panicum(2);	
				nonWeedCounter +=1;
